...
chk('confirm SIM : moteur + coût + crédits consommés + état simulation', /Seedream/.test(vSim.caption) && /PAYANT/.test(vSim.caption) && /consommés.*: 1\.44/.test(vSim.caption) && /Simulation/.test(vSim.caption));
