...
chk('D : bloc sous-titres = boîte apparence complète (disposition·police·taille·position·couleur)', (() => { const v = NAV.view({ screen: 'block', block: { screen: 'video', key: 'soustitres' } }, fvid, {}); const c = cbs(v); return ['R0_SET_stdisp_mot', 'R0_SET_stfont_archivo', 'R0_SET_stsize_S', 'R0_SET_stsize_M', 'R0_SET_stsize_L', 'R0_SET_stpos_haut', 'R0_SET_stpos_milieu', 'R0_SET_stpos_bas', 'R0_SET_stcolor_blanc', 'R0_SET_stcolor_jaune', 'R0_SET_stcolor_cyan'].every(x => c.indexOf(x) >= 0); })());
...
chk('VISIBILITÉ : R0_PH_GAL ouvre la galerie en scope GLOBAL', NAV.reduce('R0_PH_GAL', { screen: 'photo_prompt' }, fimg, ctx).st.galleryAll === true);
