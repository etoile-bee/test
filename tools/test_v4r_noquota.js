...
const bot=require('../telegram_bot.js'); const ENG=require('../ui/engines'); const BUD=require('../ui/budget');
...
(async()=>{
  ...
  chk('moteur LIVE simulé armé (R0_FORCE_LIVE) -> dépense « réelle » côté écran', ENG.live()===true);
